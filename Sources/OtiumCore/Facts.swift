...
public enum Facts {
    ...
    static let sedentarieta: [Phrase] = [
        ...
        f("Ore di immobilità aumentano il rischio di trombosi venosa: è lo stesso meccanismo della trombosi da volo lungo, la cosiddetta sindrome da classe economica.",
          "medicina vascolare, consenso scientifico",
          "Hours of immobility raise the risk of venous thrombosis: it is the same mechanism as the clots that form on a long-haul flight, known as economy class syndrome.",
