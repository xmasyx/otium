...
public enum Quotes {
    ...
    static let stoici: [Quote] = [
        ...
        q("L'anima prende il colore dei suoi pensieri.", "Such as are thy habitual thoughts, such also will be the character of thy mind; for the soul is dyed by the thoughts.", "Marco Aurelio", "Pensieri, V"),
        ...
        q("Presto avrai dimenticato tutto; presto tutti avranno dimenticato te.", "Soon you will have forgotten everything; and soon everyone will have forgotten you.", "Marco Aurelio", "Pensieri, VII"),
        ...
        q("Ogni volta che vuoi sapere cosa fuggire o cosa cercare, guarda al sommo bene, al fine di tutta la tua vita.", "As often as you wish to know what to avoid or what to seek, consider its relation to the Supreme Good, the purpose of your whole life.", "Seneca", "Lettere a Lucilio, 71"),
    ...
    static let occidentali: [Quote] = [
        ...
        q("Il primo tempo del giorno è di solito il più sopportabile.", "The earliest part of the day is ordinarily the most bearable for living beings.", "Leopardi", "Operette morali, Cantico del gallo silvestre"),
        q("Molti affanni, al mattino, paiono assai minori di quanto parvero la sera prima.", "Many misfortunes and hardships then seem less formidable than they appeared the previous evening.", "Leopardi", "Operette morali, Cantico del gallo silvestre"),
        ...
        q("Gran rimedio della maldicenza, appunto come delle afflizioni d'animo, è il tempo.", "The great remedy for slander, as for afflictions of the soul, is time.", "Leopardi", "Pensieri, XLV"),
        q("Nessun maggior segno d'essere poco filosofo e poco savio, che volere savia e filosofica tutta la vita.", "There is no surer sign of being little of a philosopher and little of a sage than wanting the whole of life to be wise and philosophical.", "Leopardi", "Pensieri, XXVIII"),
        ...
        q("L'uomo non è qui solo per farsi un'immagine del mondo già fatto, collabora lui stesso a farlo venire in essere.", "Man is not here merely to form a picture of a finished world; he himself takes part in bringing that world about.", "Rudolf Steiner", "La concezione goethiana del mondo, Personalità"),
        q("Verrebbe da dire che senza l'uomo il mondo mostrerebbe un volto non vero.", "One might say that without man the world would show an untrue countenance.", "Rudolf Steiner", "La concezione goethiana del mondo, Personalità"),
        q("Voler conoscere è un'esigenza della natura umana, non delle cose.", "The will to know is a demand of human nature, not of things.", "Rudolf Steiner", "La concezione goethiana del mondo, Personalità"),
        q("Al singolo uomo la verità appare in una veste individuale.", "To each individual man, truth appears in an individual garment.", "Rudolf Steiner", "La concezione goethiana del mondo, Personalità"),
        q("Quando l'uomo posa lo sguardo su una cosa, nasce in lui l'impulso a vedere più di quanto la percezione gli offra.", "When a man turns his gaze upon a thing, there arises in him the urge to see more than perception offers him.", "Rudolf Steiner", "La concezione goethiana del mondo, Personalità"),
        q("Si respinge tutto ciò che ostacola il pieno dispiegarsi delle forze del singolo.", "Everything is rejected that hinders the full unfolding of the individual's powers.", "Rudolf Steiner", "La filosofia della libertà, I"),
        q("Una verità che ci viene da fuori porta sempre su di sé il marchio dell'incertezza.", "A truth that comes to us from outside always bears the stamp of uncertainty.", "Rudolf Steiner", "La filosofia della libertà, I"),
        q("Possiamo credere solo a ciò che a ciascuno di noi appare come verità nel proprio intimo.", "We may believe only in what appears as truth to each of us within his own inner being.", "Rudolf Steiner", "La filosofia della libertà, I"),
        q("Chi è tormentato dai dubbi ha le forze paralizzate.", "Whoever is tormented by doubt has his powers paralysed.", "Rudolf Steiner", "La filosofia della libertà, I"),
        q("Aspiriamo a un sapere sicuro, ma ciascuno a modo suo.", "We strive for certain knowledge, but each of us in his own way.", "Rudolf Steiner", "La filosofia della libertà, I"),
        q("Chi sa godere soltanto con i sensi non conosce le leccornie della vita.", "Whoever knows how to enjoy with the senses alone does not know the delicacies of life.", "Rudolf Steiner", "La filosofia della libertà, I"),
        ...
        q("Non m'incammino nella vita con un itinerario già stabilito.", "I do not set out upon my path through life with a fixed route laid down.", "Rudolf Steiner", "La filosofia della libertà, XII"),
    ]

    // MARK: - Oriente

    static let orientali: [Quote] = [
        q("Un viaggio di mille miglia comincia con un passo.", "The journey of a thousand li commenced with a single step.", "Laozi", "Tao Te Ching, 64"),
        ...
        q("Chi sa non parla; chi parla non sa.", "He who knows the Tao does not care to speak about it; he who is ever ready to speak about it does not know it.", "Laozi", "Tao Te Ching, 56"),
        ...
        q("Come la pioggia penetra una casa mal coperta, così la passione penetra una mente non allenata.", "As rain breaks through an ill-thatched house, passion will break through an unreflecting mind.", "Buddha", "Dhammapada, I, 13"),
        q("La mente è difficile da domare, veloce, si posa dove vuole: domarla è bene.", "It is good to tame the mind, which is difficult to hold in and flighty, rushing wherever it listeth.", "Buddha", "Dhammapada, III, 35"),
        q("Goccia a goccia si riempie il secchio.", "Even by the falling of water-drops a water-pot is filled.", "Buddha", "Dhammapada, IX, 122"),
        q("Il risvegliato può solo indicare la via: siamo noi a doverla percorrere.", "You yourself must make an effort. The Tathagatas are only preachers.", "Buddha", "Dhammapada, XX, 276"),
