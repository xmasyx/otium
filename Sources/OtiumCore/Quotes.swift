...
public enum Quotes {
    ...
    static let stoici: [Quote] = [
        ...
        q("La gioia non nasce che dalla coscienza delle proprie virtù.", "Seneca", "Lettere a Lucilio, 59"),
        ...
        q("Il saggio pensa sempre a come sia la vita, non a quanta ne sia.", "Seneca", "Lettere a Lucilio, 70"),
    ...
    static let occidentali: [Quote] = [
        ...
        q("Le bocce fanno bene ai calcoli e ai reni, il tiro ai polmoni e al petto, la camminata lenta allo stomaco, la cavalcata alla testa.", "Francis Bacon", "Saggi, Degli studi"),
        q("Non leggere per contraddire, né per credere sulla parola, né per far conversazione, ma per pesare e considerare.", "Francis Bacon", "Saggi, Degli studi"),
        ...
        q("Se l'esercizio è più duro dell'uso, ne nasce grande perfezione.", "Francis Bacon", "Saggi, Della natura negli uomini"),
    ...
    static let orientali: [Quote] = [
        ...
        q("Come il fabbricante di frecce raddrizza la sua freccia, il saggio raddrizza il proprio pensiero tremante e instabile.", "Buddha", "Dhammapada, III, 33"),
        q("Il saggio sorvegli i propri pensieri, difficili da cogliere, astuti, che corrono dove vogliono: ben sorvegliati portano felicità.", "Buddha", "Dhammapada, III, 36"),
        q("Gli irrigatori guidano l'acqua, i fabbricanti di frecce piegano la freccia, i falegnami piegano il legno: i saggi danno forma a se stessi.", "Buddha", "Dhammapada, VI, 80"),
